    ...
    <>
      ...
      >
        <Link className="navbar-brand js-scroll-trigger" to="/">
          <span className="d-block d-lg-none">Anurag Gour</span>
        ...
        <div className="collapse navbar-collapse" id="navbarResponsive">
          <ul className="navbar-nav">
            ...
            <li className="nav-item">
              <Link className="nav-link js-scroll-trigger" to="/achievements">
                Achievements
              </Link>
            </li>
            <li className="nav-item">
              <Link className="nav-link js-scroll-trigger" to="/profiles">
                Profiles
              </Link>
            </li>
          </ul>
